...
static INLINE void av1_txb_init_levels_c(const tran_low_t *const coeff,
                                         const int32_t width,
    ...
    memset(
        levels - TX_PAD_TOP * stride, 0, sizeof(*levels) * TX_PAD_TOP * stride);
    memset(levels + stride * height,
           0,
